...
var sum = function(){
   // console.log(arguments instanceof Array, arguments instanceof Object, arguments.length); //false true 3
   ...
   var sum =0;
    ...
    //Error
    //arguments의 __proto__는  Object Prototype() chain이 되어 있기 때문에 ...()

    // arguments.forEach(function(e){
    //     sum+=e;
    // });

    Array.prototype.forEach.call(arguments, function(e){ //forEach 에서 this는 argumnets
        sum+=e;
    });
    return sum;
}
